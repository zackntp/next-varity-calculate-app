...
export default function Page() {
  ...
  const calculateArea = () => {
    if (!width || !height) return alert("กรุณากรอกความกว้างและความสูง");
    const result = parseFloat(width) * parseFloat(height);
    ...
    <>
      <div className="w-8/12 border border-gray-500 mx-auto mt-20 mb-10 p-20 flex flex-col items-center rounded-2xl shadow-xl">
        ...
        <div className="w-full border border-gray-300 flex flex-col items-center p-5 rounded-xl">
          <Image className="mb-5" src={square} alt="calculator" width={80} />
          <h1 className="text-lg text-blue-600 mt-1 mb-5">คำนวณพื้นที่สี่เหลี่ยม</h1>
